...
type MapProps = {
  ...
  loading?: boolean;
  /** Optional key to persist viewport in sessionStorage */
  persistKey?: string;
...
const Map = forwardRef<MapRef, MapProps>(function Map(
  ...
  useEffect(() => {
    ...
    const readPersistedViewport = (): Partial<MapViewport> | null => {
    ...
    const handleMoveEnd = () => {
      ...
      try {
        window.sessionStorage.setItem(
          `map:viewport:${persistKey}`,
          JSON.stringify(getViewport(map))
        );
      } catch {
