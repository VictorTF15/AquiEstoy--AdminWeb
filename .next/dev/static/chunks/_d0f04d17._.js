    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Map.Map.useEffect": ()=>{
            ...
            const map = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$maplibre$2d$gl$2f$dist$2f$maplibre$2d$gl$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Map({
                ...
                transformStyle: {
                    "Map.Map.useEffect": (_previousStyle, nextStyle)=>{
                        if (typeof nextStyle === "string") return nextStyle;
                        return {
                            ...nextStyle,
                            projection: nextStyle.projection ?? {
                                type: "mercator"
                            }
                        };
                    }
            ...
            if ("geolocation" in navigator) {
                navigator.geolocation.getCurrentPosition({
                    ...
                    "MapControls.useCallback[handleLocate]": (error)=>{
                        /* eslint-disable */ console.error(...oo_tx(`3300802213_897_10_897_57_11`, "Error getting location:", error));
                        setWaitingForLocation(false);
                    }
                }["MapControls.useCallback[handleLocate]"]);
            }
